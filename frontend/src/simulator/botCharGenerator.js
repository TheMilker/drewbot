(function() {
    'use strict';
    angular.module('em-drewbot').factory('botCharGenerator', botCharGenerator);

    botCharGenerator.$inject = ['simulatorConstants', 'erikFontService'];
    
    function botCharGenerator(simulatorConstants, erikFontService) {
        ...
        var erikFont = erikFontService.getFont();
        ...
        instance.convertToStrokes = (str) => {
            ...
            for (var c = 0; c < str.length; c++) {
                ...
                var currentChar = erikFont[str[c]];
